import { BadgeButton, NavBtn, WriteBtn } from "./styled-components/parts";
import { IAddBadgeButton, IErrorText, IWritePostButton } from "../interfaces/PartsInterface";
...
export function WritePostButton({ onClick }: IWritePostButton) {
  return (
